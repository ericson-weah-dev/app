 ...
 *
 * @module ForumControllers
 * @kind class
 *
 * @extends Controller
 * @requires Controller
 *
 * @classdesc ForumControllers class
 */


class ForumControllers extends require("../../../../modules/base") {
  ...
  constructor(...arrayOfObjects) {
    ...
    // auto bind methods
    this.autobind(ForumControllers);
    // auto invoke methods
    this.autoinvoker(ForumControllers);
