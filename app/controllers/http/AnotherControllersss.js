 ...
 *
 * @module AnotherControllersss
 * @kind class
 *
 * @extends Controller
 * @requires Controller
 *
 * @classdesc AnotherControllersss class
 */


class AnotherControllersss extends require("/Users/ericsonweah/Sites/development/javascript/ericson-weah-dev/zerodependency/Appundefined") {
  ...
  constructor(...arrayOfObjects) {
    ...
    // auto bind methods
    this.autobind(AnotherControllersss);
    // auto invoke methods
    this.autoinvoker(AnotherControllersss);
...
module.exports = AnotherControllersss;
